    ...
    <div className="absolute inset-0 z-50 flex flex-col bg-[#121212] text-gray-100 font-sans animate-in fade-in zoom-in-95 duration-200 rounded-lg overflow-hidden">
      ...
      <div className="flex p-2 border-b border-white/5 gap-1 bg-[#1a1a1a]/80 backdrop-blur-md">
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-md transition-colors text-[13px] font-medium ${activeTab === 'personalization'
        ...
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-md transition-colors text-[13px] font-medium ${activeTab === 'ai_providers'
              ? 'bg-blue-500/10 text-blue-400'
              : 'text-white/60 hover:bg-white/5 hover:text-white'
            }`}
        >
              ...
              <div className="flex flex-wrap gap-2">
                {['adaptive', 'transparent', 'glass', 'solid', 'custom'].map((style) => (
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg border text-[13px] capitalize transition-all ${overlayStyle === style
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg border text-[13px] transition-all ${textContrast === contrast.id
                        ? 'border-blue-500 bg-blue-500/10 text-blue-400 font-medium'
                        : 'border-white/10 bg-white/5 text-white/70 hover:border-white/30 hover:text-white'
                      }`}
                  >
